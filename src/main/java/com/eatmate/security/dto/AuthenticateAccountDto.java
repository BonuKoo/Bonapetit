...
public class AuthenticateAccountDto {
    ...
    @Builder
    public AuthenticateAccountDto(List<UploadFileOfAccount> files, List<TeamPost> teamPosts, List<Post> posts, List<AccountRole> accountRoles, List<AccountTeam> accountTeams, String roles, String password, String nickname, String email, Long id) {
        this.files = files;
