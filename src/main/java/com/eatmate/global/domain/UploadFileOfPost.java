...
public class UploadFileOfPost {
    ...
    private Post post;          // 해당 파일이 속한 엔티티

    // 파일 이름과 저장된 파일 이름을 사용하는 생성자
    public UploadFileOfPost(String uploadFileName, String storeFileName, String filePath, String fileType, long fileSize) {
