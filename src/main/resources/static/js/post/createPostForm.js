...
// 생성 시 map, 방제, 설명 validation
function createPostValidation(form) {
    var x = form.querySelector('input[name="x"]').value.trim();
    var y = form.querySelector('input[name="y"]').value.trim();
    var teamName = form.querySelector('input[name="teamName"]').value.trim();
