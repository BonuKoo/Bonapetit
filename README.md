...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-93%20passing-0F6E63" alt="tests"/>
</p>
...
| **Test** | JUnit 5, Mockito, Spring Security Test | 93건 — 저장소 · 서비스 · 컨트롤러 슬라이스 · 인가 · 쿼리 수 |
...
| [알려진 이슈](docs/known-issues.md) | 식별된 결함 15건(해소 2건)과 조치 우선순위 |
